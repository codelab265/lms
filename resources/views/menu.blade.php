        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="images/OCC_LOGO.png" alt="" height="25">
                    </span>
                    <span class="logo-lg">
                        <img src="assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">OCC_LMS</span>
                    </span>
                </a>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="category.php" data-key="t-login"><i data-feather="grid"></i> Category</a></li>
                        <li><a href="books.php" data-key="t-register"> <i data-feather="book"></i>Add Book</a></li>
                    </ul>
                </li>
                <li>
                    <a href="inventory.php">
                        <i data-feather="box"></i>
                        <span data-key="t-book">Inventory</span>
                    </a>
                </li>
                <li>
                    <a href="request.php">
