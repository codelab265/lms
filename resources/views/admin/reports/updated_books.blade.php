@extends('layout')
@section('title', 'Updated Books Reports')
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Updated books</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-start gap-2">
                        <div class="btn-group">
                            <a href="{{ route('admin.report.updated_books', 'weekly') }}"
                                class="btn btn-success waves-effect btn-label waves-light">
                                <i class="fa fa-calendar label-icon"></i>
                                Weekly
                            </a>
                            <a href="{{ route('admin.report.updated_books', 'monthly') }}"
                            ...
                            <form action="{{ route('admin.report.updated_books', ['period' => 'date']) }}" method="GET"
                                id="date_range_form">
                        ...
                        <tbody>
                            @foreach ($books as $book)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $book->edition }}</td>
                                    <td class="text-info">{{ date('d-F-Y', strtotime($book->updated_at)) }}</td>
