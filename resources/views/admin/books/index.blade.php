                ...
                <div class="card-header">
                    <div class="float-start gap-2">
                        <button type="button" class="btn btn-primary waves-effect btn-label waves-light"
                            data-bs-toggle="modal" data-bs-target="#add"><i class="bx bx-plus-circle label-icon"></i>Add
                            Book</button>
                    </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group"
                                            ...
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                                data-bs-target="#edit{{ $id }}"><i
                                                    class="bx bx-edit label-icon"></i>Edit</button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#delete{{ $id }}"><i
                                                    class="bx bx-trash label-icon"></i>Delete</button>
                                        </div>
                                    </td>
                                </tr>
